...
async def on_member_join(member):
  general.chanel = client.get_channel(1044971369902903339)
  await general.channel.send("bienvenue sur le serveur! " )
...
async def on_message(message):
    ...
    ##########################
        ...
        if aide == True and qst == 8 :
          await message.channel.send("le web est une application de l'internet")
          aide = False
          point = point + - 6
...
client.run("MTA0NDk2OTM4NTYxMTIzNTM0OQ.GWOXns.IYpjRE9v9f2SWEJNIaXdTlTNFGGWSDN2iAh8n8")